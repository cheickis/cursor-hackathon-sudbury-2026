...
Welcome to the official participant resource page for Cursor Hackathon Sudbury 2026.

This page contains the main information participants need before and during the hackathon, including event registration, Discord updates, tool setup, credits, API access, Devpost submission, and useful links.
...
Some tools may provide event credits or free access during the hackathon.

Please check:

[Credits and API Access](credits.md)

Do not share event discount codes or private access information outside the hackathon.

## Devpost Submission

Final project submissions will be handled through Devpost.
